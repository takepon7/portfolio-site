        ...
        <div className="flex flex-col gap-10 md:grid md:grid-cols-[1fr_1.2fr] md:items-start md:gap-12 lg:gap-16">
          <FadeInSection delay={80}>
            <div className="relative w-full max-w-sm md:max-w-none">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-lg border border-ink/08 bg-paper">
                <Image
                  src={PROFILE_IMAGE}
                  alt=""
                  fill
          ...
          <FadeInSection delay={120}>
            <div className="flex flex-col space-y-6 sm:space-y-8">
              <h2 className="text-[1.1rem] font-medium tracking-[0.02em] text-ink sm:text-[1.2rem]">
                Build & Culture について
              </h2>
              <p className="text-[0.95rem] tracking-[0.02em] leading-[2.2] text-ink/85 sm:text-[1rem] sm:leading-[2.25]">
              ...
              <p className="pt-2 text-right text-xs tracking-[0.18em] text-ink/40 sm:text-ink/45">
                Itabashi, Tokyo
              </p>
            </div>
          </FadeInSection>
